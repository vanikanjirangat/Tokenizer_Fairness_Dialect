...
df.to_csv("assets/tokenization_lengths_my1.csv")
...
df_unknown.to_csv("assets/tokenization_unknown_my1.csv")
...
df_unknown_fraction.to_csv("assets/tokenization_unknown_fraction_my1.csv")
...
df.to_csv("assets/tokenization_lengths_validated_my1.csv")
