...
def main(args):
    ...
    for file_path in qa_files:
        ...
        lr=2e-5
        results_dir = f"./LLM_experiments/QA_nw/{args.pretrained_ckpt}_classification_epochs-{args.epochs}_rank-{args.lora_r}_dropout-{args.dropout}_lr-{lr}_qa-{lang_code}"# Define training args
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_ckpt", default="meta-llama/Llama-3.2-3B-Instruct")
