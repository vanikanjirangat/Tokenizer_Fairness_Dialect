...
def main(args):
    ...
    #for experiment in folders:
        ...
        experiment= f"./LLM_experiments/QA/microsoft/Phi-3.5-mini-instruct_classification_epochs-5_rank-8_dropout-0.1_lr-2e-05_qa-{lang_code}"
    ...
    output_csv_path = "./metrics_output_Phi_EQA.csv"
