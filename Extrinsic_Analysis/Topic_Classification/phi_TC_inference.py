...
def main(args):
    folders= [f for f in os.listdir("./LLM_experiments/TC/microsoft") if os.path.isdir(f"./LLM_experiments/TC/microsoft//{f}")]
    ...
    for experiment in folders:
        ...
        base_path = "./LLM_experiments/TC/microsoft/"
    ...
    output_csv_path = "./metrics_output_sample_eng.csv"
